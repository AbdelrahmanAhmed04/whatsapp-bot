...
####SETTING UP CUSTOM COMMANDS####
    ...
    if "send custom message to number" in message_body:
        ...
        def process_custom_message(message_body):
            ...
            log_message_in_dynamodb(phone_number, "sent manual message to " + phone_number, "outgoing", message_sid, profile_name, to_number)
    ...
    if "send 888 offer message" in message_body:
        ...
        for number in phone_numbers:
            ...
            log_message_in_dynamodb(number, "sent casino 888 offer message manually to " + number, "outgoing", message.sid, profile_name, to_number)
    ...
    if "send betfinal offer message" in message_body:
        ...
        for number in phone_numbers:
            ...
            log_message_in_dynamodb(number, "sent casino betfinal offer message manually to " + number, "outgoing", message.sid, profile_name, to_number)
            logging.info(f"Message sent to {number}")
        # Send the message via Twilio
